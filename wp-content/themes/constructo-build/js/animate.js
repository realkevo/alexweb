...
jQuery(function ($) {
  ...
  $(document).on('constructobuildSlideChangeTransitionStart', function () {
  ...
  function constructobuild_photography_slider_animation(selector) {
  ...
  $(document).on('constructobuildSlideinit', function () {
    var observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          constructobuild_photography_slider_animation('.swiper-slide-active');
          return;
        }
      });
    });
    observer.observe(document.querySelector('.swiper-wrapper'));
  }); // constructobuild_photography_slider_animation('.swiper-slide:first-child');

  $(document).on('constructobuildSlideChangeTransitionEnd', function () {
    constructobuild_photography_slider_animation('.swiper-slide-active');
  });
});